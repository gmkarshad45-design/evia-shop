...
# FIX: Added this route because your index.html links to it
...
def init_db():
    ...
    p1 = Product(name="Sample Watch", price=1500, description="Classic Watch", image="")
    db.session.add(admin)
    db.session.add(p1)
    db.session.commit()
    return "Fix Complete! Login: admin@test.com | admin123"
