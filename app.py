...
app = Flask(__name__)
app.config['SECRET_KEY'] = 'evia_premium_secret_2026'
...
class Order(db.Model):
    ...
    status = db.Column(db.String(50), default="Placed") # Placed, Shipped, Out for Delivery, Delivered, Cancelled, Return Requested
