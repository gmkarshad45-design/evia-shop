...
# --- DATABASE CONFIGURATION (SINGAPORE COMPATIBLE) ---
...
# --- DATABASE INITIALIZATION (WEDNESDAY TYPE) ---
def init_db():
    try:
        with app.app_context():
            db.create_all()
            print("🟢 Singapore Database Connected Successfully!")
...
def buy_now(id):
    # This route fixes the BuildError in your logs
...
def checkout():
    ...
    if request.method == 'POST':
        ...
        new_order = Order(
            product_details=f"Item: {product.name} | Mob: {phone} | Addr: {address}",
